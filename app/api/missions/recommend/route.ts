...
export async function POST(request:Request){
  try{
    ...
    await admin.from('notifications').insert({recipient_id:parentMember.data.profile_id,family_id:conquest.data.family_id,type:'JOURNEY_REVIEW',title:'Uma nova conquista precisa da sua revisão.',message:'A KONKI preparou uma jornada contextualizada.',related_entity_id:journey.data.id,deep_link:'/?view=journey-review'});
