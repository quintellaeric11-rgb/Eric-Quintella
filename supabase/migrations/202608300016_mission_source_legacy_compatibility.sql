-- Legacy drafts were generated with is_custom=true even when full KONKI pedagogy
-- was present. Infer Parent-authored missions from both the flag and missing
-- pedagogical content so those drafts remain correct after this release.
