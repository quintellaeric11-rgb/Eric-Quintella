...
export type AppRoute={view:AppView;assignmentId?:string;contractId?:string};
...
export function parseAppRoute(value:string,defaultView:AppView='home'):AppRoute{
  ...
  return{view,assignmentId:assignment&&uuid.test(assignment)?assignment:undefined,contractId:contract&&uuid.test(contract)?contract:undefined};
}
